...
il s'agit d'un ordre non exhaustif il faut simplement respecter les primary et les foreign keys en sachant que les primary keys d'une table doivent être implémenter avant les foreign keys, pour cela il est juditieux de commencer par une table sans foreign key comme dans mon cas la table countries puis continuer dans l'ordre en respectant cette régles.
*/
...
-- montrer l'image insertion de countries
...
-- montrer l'image d'insertion de products
...
-- insertion de la table customers
...
-- insertion de la table orders_details
