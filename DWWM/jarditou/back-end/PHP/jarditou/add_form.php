...
<form action="add_script.php" method="POST"><br>
    <div class="text-center">
        <input type="hidden" name='pro_id' value=''>
    </div>
    <div class="form-group">
        <label for="reference">Référence :</label><br>
        <input type="text" name="reference" class="col-12 form-control" value="">
    </div>
    ...
    <!-- <div class="form-group">
        ...
        <input type="text" name="categorie" class="col-12 form-control" value="">
    </div> -->


    <div class="form-group">
        <label for="libelle">Libellé :</label><br>
        <input type="text" name="libelle" class="col-12 form-control" value="">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="prix" class="col-12 form-control" value="" >
    </div>
    <div class="form-group">
        <label for="stock">Stock :</label><br>
        <input type="text" name="stock" class="col-12 form-control" value="" >
    </div>
    <div class="form-group">
        <label for="couleur">Couleur :</label><br>
        <input type="text" name="couleur" class="col-12 form-control" value="" >
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <a href='tableau.php'>
            <button type="reset" class="col-3 btn btn-danger">Annuler</button>
        </a>
    </div>
</form>
